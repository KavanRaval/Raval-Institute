...
<div class="container">
    ...
    <div class="card-deck">
        ...
        <?php
        $stdID = $_SESSION['USERID'];
        $qry = "select * from tbl_lectures join tbl_subject on tbl_lectures.subject_id=tbl_subject.subject_id  where stream_id in (select stream_id from tbl_faculty where faculty_id = '$stdID') order by tbl_lectures.lecture_start asc";
